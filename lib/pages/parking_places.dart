...
Placemark address  =Placemark();
  ...
  void fromCoordinatesToAdrress(String location ,int index) async{
    if(location.isNotEmpty){
      ...
      LatLng startingPoint = const LatLng(60.3791338480793, 5.360316855799164);
      LatLng endPoint =LatLng(latitude, longitude);

      ConvertToKiloMeters convertToKiloMeters =ConvertToKiloMeters();
      String distanceChanged = convertToKiloMeters.changeToKilometers(startingPoint, endPoint);
                ...
                GestureDetector(
                 ...
                 scaffoldKey.currentState?.openDrawer();
                  ...
                  child: Container(
                      ...
                      child: Icon(Icons.menu_rounded, color: MyColors.grey_10,)),
                ),
                CustomText(
                    text: "Search Parking",
