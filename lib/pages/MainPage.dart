...
class _MainPageState extends State<MainPage>  {
  ...
  void addMarkers() {
    for (int a =1; a<listMarker.length; a++)   {
    _markers.add(Marker(
      markerId: MarkerId(listMarker[a].toString()),
      position: listMarker[a],
      infoWindow: const InfoWindow(title: "Parking spot",snippet: "Free"),
              ...
              child: Material(
                ...
                child: InkWell(
                  ...
                  child: const SizedBox(
                    width: 56,
                    height: 56,
                    child: Icon(Icons.my_location, color: MyColors.grey_20,),
                  ),
                  onTap: () async {
