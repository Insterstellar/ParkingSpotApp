 ...
 List<Widget> _noItemWidget = [
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: userFavoriteItems.isEmpty ? const NoItemsFoundPage() :SafeArea(
        child: Padding(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  ClipRRect(
                      borderRadius: BorderRadius.circular(50),
                      child: Image.asset("assets/images/carpark.jpeg", fit: BoxFit.cover, height: 40, width: 40,)),
                ],
              ),
              SizedBox(height: 20,),
              Row(
